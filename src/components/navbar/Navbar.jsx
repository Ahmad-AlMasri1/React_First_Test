            ...
            <div className="container mx-auto navbar bg-base-100 px-1 ">
                <div className="navbar-start gap-3">
                    <div className="drawer w-8 mb-1.5 lg:hidden">
                        ...
                        <div className="drawer-content">
                            ...
                            <label htmlFor="my-drawer-1" className="btn btn-ghost btn-circle drawer-button"><img className="size-10" src="./src/assets/icons/menu-line-horizontal.svg"/></label>
                        </div>
                        <div className="drawer-side">
                            ...
                            <div className="menu bg-base-200 min-h-full w-80 p-6">
                                ...
                                <div className="row justify-between">
                                    ...
                                    <label htmlFor="my-drawer-1" aria-label="close sidebar" className="drawer-overlay btn btn-ghost"><img className="w-7"  src="./src/assets/icons/close.svg"/></label>
                                </div>
                                ...
                                <ul>
                                    ...
                                    <li><Link to="pizza" className="font-Inter text-[14px]/[24px] font-medium pb-2 border-b-2 border-b-[#E8ECEF]">pizza</Link></li>
                                    <li><Link to="pasta" className="font-Inter text-[14px]/[24px] font-medium pb-2 border-b-2 border-b-[#E8ECEF]">pasta</Link></li>
                                    <li><Link to="salad" className="font-Inter text-[14px]/[24px] font-medium pb-2 border-b-2 border-b-[#E8ECEF]">salad</Link></li>
                                ...
                                <div className="bot">
                                    ...
                                    <ul className="row justify-start gap-6 items-start">
                                        <li><Link to=""><img src="./src/assets/icons/instagram.svg"/></Link></li>
                                        <li><Link to=""><img src="./src/assets/icons/facebook.svg"/></Link></li>
                                        <li><Link to=""><img src="./src/assets/icons/youtube.svg"/></Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div className="navbar-center">
                    <ul className="row gap-10 max-lg:hidden">
                        <li><Link to="/" href="index.html" className="font-Space-Grotesk text-[14px]/[24px] text-[#6C7275] hover:text-black font-bold">Home</Link></li>
                        <li><Link to="pizza" className="font-Space-Grotesk text-[14px]/[24px] font-bold text-[#6C7275] hover:text-black transition-all delay-125">pizza</Link></li>
                        <li><Link to="pasta" className="font-Space-Grotesk text-[14px]/[24px] font-bold text-[#6C7275] hover:text-black transition-all delay-125">pasta</Link></li>
                        <li><Link to="salad" className="font-Space-Grotesk text-[14px]/[24px] font-bold text-[#6C7275] hover:text-black transition-all delay-125">salad</Link></li>
